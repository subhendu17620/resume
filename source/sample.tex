...
\begin{center}
  \textbf{\Huge Subhendu Maji} \\ \vspace{1pt}
...
\resumeItemListStart
\resumeItem{111 Beam is a unified model for defining both batch and streaming data-parallel processing pipelines}
...
\resumeSubSubheading
{Software Development Intern}{May 2024 - Present}
\resumeItemListStart
\resumeItem{Apache Beam is a unified model for defining both batch and streaming data-parallel processing pipelines}
\resumeItem{Apache Beam is a unified model for defining both batch and streaming data-parallel processing pipelines}
\resumeItem{Apache Beam is a unified model for defining both batch and streaming data-parallel processing pipelines}
